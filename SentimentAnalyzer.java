...
class SentimentAnalyzer {
	...
	public static int[] detectProsAndCons(String review, String[][] featureSet, String[] posOpinionWords,
		...
		int index = 0;
		for (String[] ss: featureSet) { // For each feature
			for (String s: ss) {		// Check feature synonyms
				featureOpinions[index] = getOpinionOnFeature(review.toLowerCase(), s, posOpinionWords, negOpinionWords);
	...
	private static int checkForWasPhrasePattern(String review, String feature, String[] posOpinionWords, String[] negOpinionWords) {
		int opinion = 0;
		String pattern = feature + " was "; // Let's do this without tokenizing the string around spaces, since we have this pattern string provided.
